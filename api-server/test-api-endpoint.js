...
async function testApiEndpoint() {
    try {
        ...
        const url = `https://swimming-system-api-production.up.railway.app/coach-roster?phone=${encodeURIComponent(phone)}&name=${encodeURIComponent(name)}&year=${year}&month=${month}`;
